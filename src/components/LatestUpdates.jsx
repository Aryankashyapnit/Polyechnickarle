              ...
              {notifications.map((item) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    {/* Date Widget */}
                    <div className="flex flex-col items-center justify-center bg-gradient-to-br from-brand-primary to-purple-600 text-white rounded-xl h-14 w-14 flex-shrink-0 select-none font-outfit shadow-sm">
                      <span className="text-[9px] font-bold tracking-widest uppercase text-purple-200/90 leading-none -mr-[0.1em]">{item.month}</span>
                      <span className="text-xl font-extrabold leading-none mt-1">{item.day}</span>
                    </div>
